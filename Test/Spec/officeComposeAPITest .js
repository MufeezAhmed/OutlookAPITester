...
var newMessageText = "Hello World";


describe("Compose: office api Test",
    function () {
        ...
        afterAll(function () {
           ...
           var completeHtml = "<html>" + $("html").html() + "</html>";
            ...
            var request = '<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:m="http://schemas.microsoft.com/exchange/services/2006/messages"' +
                ...
                '      <m:Items>' +
                '        <t:Message>' +
                '          <t:Subject>Compose Test Results Using EWS Request</t:Subject>' +
            ...
            function cb(asyncResult) {
                ...
                var emailData = {
                    "Message": {
                        "Subject": "Compose Test Results Using REST API",
                        "Body": {
                            "ContentType": "Html",
